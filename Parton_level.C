...
// Define histogram here
    ...
    TH1D *h_lepton1_Pt = new TH1D("h_lepton1_Pt", "h_lepton1_Pt", 50, 0, 800) ;
    ...
    TH1D *h_MET_Pt = new TH1D("h_MET_Pt", "h_MET_Pt", 50, 0, 400) ;
...
// Set branch addresses----------------------------------------------------------------------------------------------------------------------------------------------
   ...
   LHEF->SetBranchAddress("Particle.Status",Particle_Status);
 ...
 //    std::cout << "test momIdW2_0 [" << momIdW2_0 << "] " << Particle_PID[momIdW2_0]  << "\n" ; 
  //   std::cout << "test momIdW2_1 [" << momIdW2_1 << "] " << Particle_PID[momIdW2_1]  << "\n" ; 
   //  std::cout << "test momIdW2_2 [" << momIdW2_2 << "] " << Particle_PID[momIdW2_2]  << "\n" ; 
    // std::cout << "test grandmomIdW2_1 [" << grandmomIdW2_1 << "] " << abs(Particle_PID[grandmomIdW2_1])  << "\n" ; 
     //std::cout << "test grandmomIdW2_2 [" << grandmomIdW2_2 << "] " << abs(Particle_PID[grandmomIdW2_2])  << "\n" ; 
...
//TFile Plot ("Plot.C", "recreate");      
   ...
   TFile histosFile ("file2_scale_1lakh.root","recreate") ;
 //  Plot.cd ();
   histosFile.cd () ; 
   
   
   
    h_top_quark_M->Scale(1/h_top_quark_M->Integral());         
 //   W_mass->Scale(1/W_mass->Integral());  
 //   Z_mass->Scale(1/Z_mass->Integral() ) ; 
    h_b_quark_Pt->Scale(1/h_b_quark_Pt->Integral() );  
    h_b_quark_Eta->Scale(1/h_b_quark_Eta->Integral());  
    h_b_quark_Phi->Scale(1/h_b_quark_Phi->Integral() ) ; 
    h_forw_jet_Pt->Scale(1/h_forw_jet_Pt->Integral() ) ; 
    h_forw_jet_Eta->Scale(1/h_forw_jet_Eta->Integral() );  
    h_forw_jet_Phi->Scale(1/h_forw_jet_Phi->Integral() )  ; 
    h_quarks1_Pt->Scale(1/h_quarks1_Pt->Integral() )  ;
    h_quarks1_Eta->Scale(1/h_quarks1_Eta->Integral() ) ; 
    h_quarks1_Phi->Scale(1/h_quarks1_Phi->Integral() )  ;
    h_quarks2_Pt->Scale(1/h_quarks2_Pt->Integral() )  ;
    h_quarks2_Eta->Scale(1/h_quarks2_Eta->Integral() ) ; 
    h_quarks2_Phi->Scale(1/h_quarks2_Phi->Integral() )  ;
    h_lepton1_Pt->Scale(1/h_lepton1_Pt->Integral() ) ; 
    h_lepton1_Eta->Scale(1/h_lepton1_Eta->Integral() ) ; 
    h_lepton1_Phi->Scale(1/h_lepton1_Phi->Integral() )  ;
    h_lepton2_Pt->Scale(1/h_lepton2_Pt->Integral() )  ;
    h_lepton2_Eta->Scale(1/h_lepton2_Eta->Integral() ) ; 
    h_lepton2_Phi->Scale(1/h_lepton2_Phi->Integral() )  ;
    h_lepton3_Pt->Scale(1/h_lepton3_Pt->Integral() )  ;
    h_lepton3_Eta->Scale(1/h_lepton3_Eta->Integral() ) ; 
    h_lepton3_Phi->Scale(1/h_lepton3_Phi->Integral() )  ;
    h_MET_Pt->Scale(1/h_MET_Pt->Integral() )  ;
    h_MET_Eta->Scale(1/h_MET_Eta->Integral() )  ;
